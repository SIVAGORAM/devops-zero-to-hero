...
A software company is like a hospital. A hospital doesnt only have doctors-it relies on receptionists, nurses, pharmacists, and lab technicians working together to treat a patient. Similarly, building software requires multiple distinct roles working together as a team.
...
---
**[Next: Day 4 - OS & Virtualization](../01-Operating-System/Day-04-OS-and-Virtualization.md)**
