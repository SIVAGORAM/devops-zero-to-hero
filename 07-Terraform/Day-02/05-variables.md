...
Input variables are used to parameterize your Terraform configurations. They allow you to pass values into your modules or configurations from the outside, preventing hardcoding.
...
- `default` provides a fallback default value for the variable, which is optional.
...
Output variables allow you to expose values from your module or configuration, making them available for use in other parts of your Terraform setup, or simply printing them to the screen after a successful deployment.
...
- `value` specifies the value that you want to expose. This value can be a resource attribute, a computed value, or any other expression.
